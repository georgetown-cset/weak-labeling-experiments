...
def get_data(relevant=1000, irrelevant=700, confusable=700, save=True, local=True):
    
    if(local and path.exists("data.csv")):
        data = pd.read_csv("data.csv", prefix=None).sample(
